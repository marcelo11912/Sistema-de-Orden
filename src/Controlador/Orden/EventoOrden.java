...
public class EventoOrden {
    ...
    private void AgregarOrden(JTextField fTotal, JTextField fSubTotal, JTextField fIva0, JTextField fIva12, JTextField fCantidad, JTextField fPrecio, JTextField fId, JTextField fServicio, JTable tableOrden, JTextField fNombreApellido, JTextField fNombreEmpresa, JTextField fNumOrden, JComboBox cEstadoOrden, JTextField fSaldo) {
    ...
    public void Guardar(JComboBox cEstadoOrden, JTextField fSubTotal, JTextField fSaldo, JTextField fTotal, JTextField fNombreEmpresa, JTextField fNombreApellido, JTextField fFechaOrden, JTextField fNumOrden, JTable tableOrden) {
        ...
        if (cEstadoOrden.getSelectedItem() == "PAGADA") {
